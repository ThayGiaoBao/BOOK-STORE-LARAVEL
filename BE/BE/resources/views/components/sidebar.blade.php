...
<a href="{{ route('Dashboard') }}" class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Profond</div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Danh sách coupon</a>
            <a class="collapse-item" href="#">Quản lý coupon</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    <a class="nav-link" href="#">
        ...
        <span>Tổng quan giao dịch</span></a>
</li>
...
<li class="nav-item">
    <a class="nav-link" href="#">
        ...
        <span>Sản phẩm ưa chuộng</span></a>
</li>
