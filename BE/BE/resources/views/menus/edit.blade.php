...
<div class="container-fluid">
    ...
    <div class="card shadow-none border-0 mb-4">
        <form action="{{ route('menus.update', ['id'=>$menuFollowIdEdit->id]) }}" method="post" style="background-color: #f8f9fc">
             @csrf
            <div class="form-group">
                <label>Tên Menus</label>
                <input type="text" name="name" class="form-control" placeholder="Nhập tên menus" value="{{ $menuFollowIdEdit->name }}">
            </div>
            <div class="form-group">
